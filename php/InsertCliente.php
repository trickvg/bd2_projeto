...
//session_destroy("cadastro");
	...
	if(empty($p_nome_cliente) || empty($p_cpf) || empty($p_endereco) || empty($p_email) || empty($p_telefone)) {
...
if (!$conn) {
   ...
   // trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
		...
		$sql = "BEGIN p_insert_cliente(:p_nome_cliente, :p_cpf, :p_endereco, :p_email, :p_telefone); END;";
